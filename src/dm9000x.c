...
/*TODO: hardcode buggy*/
char* NetRxPackets[]={(char*)0x6000}; //receiving buffer	address
...
//	int tmo;
	...
	gpmi_dm9000_write_reg_index(DM9000_MWCMD);
...
/*		if (get_timer(0) >= tmo) {
	...
	/*DM9000_DBG*/printf("transmit done\n\n");
	return 0;
}
...
*/
static int dm9000_rx(struct eth_device *netdev, void (*NetReceive)(char *, int))
{
	...
	for (;;) {
		...
		//gpmi_dm9000_write_reg_index(DM9000_MRCMDX);
		...
		/*DM9000_DBG*/printf("receiving packet\n");
...
int dm9000_initialize(void/*bd_t *bis*/)
{
